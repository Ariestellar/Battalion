...
public class SquadFactoryPlayer : MonoBehaviour, SquadFactory
{
    ...
    public GameObject CreateSquad(GameObject squadUI, string name, Vector3 currentPosition, TypeArmy typeArmy)
    {
        ...
        squad.name = name;
        squad.AddComponent<SquadPlayer>();

        SquadData squadData = SquadData.CreateSquadData(name, Side.Player, _clickHandler, squadUI);
